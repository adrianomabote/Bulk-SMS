...
// Marcar que usuário se registrou
...
function girarRoleta() {
    // Verificar se já usou as 2 tentativas (incluindo sessões anteriores)
...
function showPopUp() {
    ...
    if (premio === 'BOA SORTE') {
        if (tentativas === 1) {
            mensagem = '❌ Não foi dessa vez!<br>Você tem mais 1 chance.<br>Clique no botão abaixo e gire novamente!';
            btnGirarNovamente.style.display = 'inline-block';
            btnRegistro.style.display = 'none';
        } else {
            mensagem = '😅 Boa sorte!<br>Você esgotou suas 2 tentativas grátis.<br>Tente novamente mais tarde!';
            btnGirarNovamente.style.display = 'none';
            btnRegistro.style.display = 'none';
        }
    } else {
        if (tentativas === 1) {
            mensagem = `🎉 Parabéns! Você ganhou <b>${premio.toLocaleString('pt-BR')} Meticais!</b><br><br>Você tem mais 1 chance para girar e ganhar ainda mais!<br>Clique abaixo para fazer sua segunda tentativa!`;
            btnGirarNovamente.style.display = 'inline-block';
            btnRegistro.style.display = 'none';
        } else {
            mensagem = `🤑 Parabéns! Você ganhou <b>${premio.toLocaleString('pt-BR')} Meticais!</b><br><br>Para receber, registre-se na plataforma clicando no botão abaixo e <b>deposite 1 ou 5 Meticais</b> para que possamos confirmar seu número e enviar o valor.<br><br>⚠️ <b>O prêmio só será entregue para quem criar uma nova conta na plataforma.</b><br>Se já possui uma conta, é necessário criar uma nova para receber o valor na sua carteira móvel!`;
            btnGirarNovamente.style.display = 'none';
...
function mostrarMensagemCompartilhar() {
    const mensagem = '⚠️ Você já usou suas 2 tentativas grátis!<br><br>📲 Para ganhar mais giros, compartilhe este site com seus amigos no WhatsApp.<br><br>Cada pessoa que entrar pelo seu link te dá +1 giro grátis!';
    document.getElementById('popupText').innerHTML = mensagem;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Se já se registrou, esconder popup caso esteja visível
    if (jaRegistrou) {
        document.getElementById('popup').style.display = 'none';
    }
});
